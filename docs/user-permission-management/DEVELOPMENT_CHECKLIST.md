...
| 狀態 | 任務 | 檔案 |
|------|------|------|
| ⬜ | 建立 `EXPORT_CONFIG` 設定陣列 | `src/renderer/pages/home/index.tsx` |
...
| 狀態 | 任務 | 檔案 |
|------|------|------|
| ⬜ | 加 `role` / `permissions` / `authUser` state | `src/renderer/contexts/auth-dialog-context/index.tsx` |
...
| 日期 | 內容 |
|------|------|
| 2026-06-02 | 建立規格文件（FEATURE_SPEC / IMPLEMENTATION_PLAN / DEVELOPMENT_CHECKLIST），待使用者審核 |
